...
namespace MonoTests.System
{
	...
	public class MathTest
	{
		...
		*/
		...
		{
			Assert.AreEqual (1D, Math.Round (1D, 0, MidpointRounding.ToEven), double_epsilon, "#1");
			Assert.AreEqual (1D, Math.Round (1D, 0, MidpointRounding.AwayFromZero), double_epsilon, "#2");

			Assert.AreEqual (-1D, Math.Round (-1D, 0, MidpointRounding.ToEven), double_epsilon, "#3");
			Assert.AreEqual (-1D, Math.Round (-1D, 0, MidpointRounding.AwayFromZero), double_epsilon, "#4");

			Assert.AreEqual (1D, Math.Round (1D, 1, MidpointRounding.ToEven), double_epsilon, "#5");
			Assert.AreEqual (1D, Math.Round (1D, 1, MidpointRounding.AwayFromZero), double_epsilon, "#6");

			Assert.AreEqual (-1D, Math.Round (-1D, 1, MidpointRounding.ToEven), double_epsilon, "#7");
			Assert.AreEqual (-1D, Math.Round (-1D, 1, MidpointRounding.AwayFromZero), double_epsilon, "#8");

			Assert.AreEqual (1D, Math.Round (1.2345D, 0, MidpointRounding.ToEven), double_epsilon, "#9");
			Assert.AreEqual (1D, Math.Round (1.2345D, 0, MidpointRounding.AwayFromZero), double_epsilon, "#A");

			Assert.AreEqual (-1D, Math.Round (-1.2345D, 0, MidpointRounding.ToEven), double_epsilon, "#B");
			Assert.AreEqual (-1D, Math.Round (-1.2345D, 0, MidpointRounding.AwayFromZero), double_epsilon, "#C");

			Assert.AreEqual (1.2D, Math.Round (1.2345D, 1, MidpointRounding.ToEven), double_epsilon, "#D");
			Assert.AreEqual (1.2D, Math.Round (1.2345D, 1, MidpointRounding.AwayFromZero), double_epsilon, "#E");

			Assert.AreEqual (-1.2D, Math.Round (-1.2345D, 1, MidpointRounding.ToEven), double_epsilon, "#F");
			Assert.AreEqual (-1.2D, Math.Round (-1.2345D, 1, MidpointRounding.AwayFromZero), double_epsilon, "#10");

			Assert.AreEqual (1.23D, Math.Round (1.2345D, 2, MidpointRounding.ToEven), double_epsilon, "#11");
			Assert.AreEqual (1.23D, Math.Round (1.2345D, 2, MidpointRounding.AwayFromZero), double_epsilon, "#12");

			Assert.AreEqual (-1.23D, Math.Round (-1.2345D, 2, MidpointRounding.ToEven), double_epsilon, "#13");
			Assert.AreEqual (-1.23D, Math.Round (-1.2345D, 2, MidpointRounding.AwayFromZero), double_epsilon, "#14");

			Assert.AreEqual (1.234D, Math.Round (1.2345D, 3, MidpointRounding.ToEven), double_epsilon, "#15");
			Assert.AreEqual (1.235D, Math.Round (1.2345D, 3, MidpointRounding.AwayFromZero), double_epsilon, "#16");

			Assert.AreEqual (-1.234D, Math.Round (-1.2345D, 3, MidpointRounding.ToEven), double_epsilon, "#17");
			Assert.AreEqual (-1.235D, Math.Round (-1.2345D, 3, MidpointRounding.AwayFromZero), double_epsilon, "#18");

			Assert.AreEqual (1.2345D, Math.Round (1.2345D, 4, MidpointRounding.ToEven), double_epsilon, "#19");
			Assert.AreEqual (1.2345D, Math.Round (1.2345D, 4, MidpointRounding.AwayFromZero), double_epsilon, "#1A");

			Assert.AreEqual (-1.2345D, Math.Round (-1.2345D, 4, MidpointRounding.ToEven), double_epsilon, "#1B");
			Assert.AreEqual (-1.2345D, Math.Round (-1.2345D, 4, MidpointRounding.AwayFromZero), double_epsilon, "#1C");

			Assert.AreEqual (2D, Math.Round (1.5432D, 0, MidpointRounding.ToEven), double_epsilon, "#1D");
			Assert.AreEqual (2D, Math.Round (1.5432D, 0, MidpointRounding.AwayFromZero), double_epsilon, "#1E");

			Assert.AreEqual (-2D, Math.Round (-1.5432D, 0, MidpointRounding.ToEven), double_epsilon, "#1F");
			Assert.AreEqual (-2D, Math.Round (-1.5432D, 0, MidpointRounding.AwayFromZero), double_epsilon, "#20");

			Assert.AreEqual (1.5D, Math.Round (1.5432D, 1, MidpointRounding.ToEven), double_epsilon, "#21");
			Assert.AreEqual (1.5D, Math.Round (1.5432D, 1, MidpointRounding.AwayFromZero), double_epsilon, "#22");

			Assert.AreEqual (-1.5D, Math.Round (-1.5432D, 1, MidpointRounding.ToEven), double_epsilon, "#23");
			Assert.AreEqual (-1.5D, Math.Round (-1.5432D, 1, MidpointRounding.AwayFromZero), double_epsilon, "#24");

			Assert.AreEqual (1.54D, Math.Round (1.5432D, 2, MidpointRounding.ToEven), double_epsilon, "#25");
			Assert.AreEqual (1.54D, Math.Round (1.5432D, 2, MidpointRounding.AwayFromZero), double_epsilon, "#26");

			Assert.AreEqual (-1.54D, Math.Round (-1.5432D, 2, MidpointRounding.ToEven), double_epsilon, "#27");
			Assert.AreEqual (-1.54D, Math.Round (-1.5432D, 2, MidpointRounding.AwayFromZero), double_epsilon, "#28");

			Assert.AreEqual (1.543D, Math.Round (1.5432D, 3, MidpointRounding.ToEven), double_epsilon, "#29");
			Assert.AreEqual (1.543D, Math.Round (1.5432D, 3, MidpointRounding.AwayFromZero), double_epsilon, "#2A");

			Assert.AreEqual (-1.543D, Math.Round (-1.5432D, 3, MidpointRounding.ToEven), double_epsilon, "#2B");
			Assert.AreEqual (-1.543D, Math.Round (-1.5432D, 3, MidpointRounding.AwayFromZero), double_epsilon, "#2C");

			Assert.AreEqual (1.5432D, Math.Round (1.5432D, 4, MidpointRounding.ToEven), double_epsilon, "#2D");
			Assert.AreEqual (1.5432D, Math.Round (1.5432D, 4, MidpointRounding.AwayFromZero), double_epsilon, "#2E");

			Assert.AreEqual (-1.5432D, Math.Round (-1.5432D, 4, MidpointRounding.ToEven), double_epsilon, "#2F");
			Assert.AreEqual (-1.5432D, Math.Round (-1.5432D, 4, MidpointRounding.AwayFromZero), double_epsilon, "#30");

			Assert.AreEqual (63988D, Math.Round (63987.83593942D, 0, MidpointRounding.ToEven), double_epsilon, "#31");
			Assert.AreEqual (63988D, Math.Round (63987.83593942D, 0, MidpointRounding.AwayFromZero), double_epsilon, "#32");

			Assert.AreEqual (-63988D, Math.Round (-63987.83593942D, 0, MidpointRounding.ToEven), double_epsilon, "#33");
			Assert.AreEqual (-63988D, Math.Round (-63987.83593942D, 0, MidpointRounding.AwayFromZero), double_epsilon, "#34");

			Assert.AreEqual (63987.83594D, Math.Round (63987.83593942D, 5, MidpointRounding.ToEven), double_epsilon, "#35");
			Assert.AreEqual (63987.83594D, Math.Round (63987.83593942D, 5, MidpointRounding.AwayFromZero), double_epsilon, "#36");

			Assert.AreEqual (-63987.83594D, Math.Round (-63987.83593942D, 5, MidpointRounding.ToEven), double_epsilon, "#37");
			Assert.AreEqual (-63987.83594D, Math.Round (-63987.83593942D, 5, MidpointRounding.AwayFromZero), double_epsilon, "#38");

			Assert.AreEqual (63987.83593942D, Math.Round (63987.83593942D, 8, MidpointRounding.ToEven), double_epsilon, "#39");
			Assert.AreEqual (63987.83593942D, Math.Round (63987.83593942D, 8, MidpointRounding.AwayFromZero), double_epsilon, "#3A");

			Assert.AreEqual (-63987.83593942D, Math.Round (-63987.83593942D, 8, MidpointRounding.ToEven), double_epsilon, "#3B");
			Assert.AreEqual (-63987.83593942D, Math.Round (-63987.83593942D, 8, MidpointRounding.AwayFromZero), double_epsilon, "#3C");
		}
#endif
